  ...
  <link rel="stylesheet" href="{{ asset('themes/plugins/datatables-select/css/select.bootstrap4.min.css') }}">
  <link rel="stylesheet" href="{{ asset('themes/plugins/datatables-buttons/css/buttons.bootstrap4.min.css') }}">
  <!-- Loader -->
  <link rel="stylesheet" href="{{ asset('themes/plugins/loader/loader.css')}}">
