    ...
    <div class="col">
        <div class="card mt-3">
            <div class="card-header">
                <button id="create-record" class="btn btn-sm btn-success rounded"><i class="fa fa-plus"></i> Tambah</button>
            </div>
            <div class="card-body">
                <div class="table table-responsive">
                    <input type="hidden" id="url-dtTableCustomer" value="{{ route('admin.dtTableCustomer') }}">
                    <table id="dtTableCustomer" class="table table-sm table-hover table-bordered table-striped">
                        <thead>
